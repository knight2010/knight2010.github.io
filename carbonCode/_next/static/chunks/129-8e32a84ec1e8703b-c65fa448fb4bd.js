...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [129], {
        32915: function(e, t, n) {
            ...
            t.ZP = function(e) {
                var t = l(i.useState(null), 2),
                    n = t[0],
                    a = t[1];
                return i.useEffect((function() {
                    o.ZP && o.ZP.auth().onAuthStateChanged((function(e) {
                        return a(e)
                    }))
                }), []), i.useEffect((function() {
                    n ? n.getIdToken().then((function(e) {
                        c.L.defaults.headers.Authorization = e ? "Bearer ".concat(e) : void 0
                    })) : delete c.L.defaults.headers.Authorization
                }), [n]), (0, r.jsx)(s.Provider, {
                    value: n,
                    children: e.children
                })
            }
        ...
        13576: function(e, t, n) {
            ...
            t.Z = function(e) {
                var t = e.id,
                    ...
                    u = e.background,
                    d = void 0 === u ? a.DM.BLACK : u,
                    f = e.color,
                    p = void 0 === f ? a.DM.SECONDARY : f,
                    b = e.textColor,
                    x = e.hoverBackground,
                    m = void 0 === x ? a.DM.HOVER : x,
                    h = e.hoverColor,
                    y = e.disabled,
                    g = e.selected,
                    j = e.children,
                    ...
                    L = void 0 === N ? "button" : N,
                    S = e.display,
                    z = s(e, ["id", "onClick", "background", "color", "textColor", "hoverBackground", "hoverColor", "disabled", "selected", "children", "border", "center", "large", "flex", "padding", "margin", "title", "Component", "display"]);
                return (0, r.jsxs)(L, function(e) {
                    ...
                    className: o().dynamic([
                        ["23472259c69ef05e", [L, S || "flex", R, d, b || p, v ? "inset 0px 0px 0px ".concat(g ? 2 : 1, "px ").concat(p) : "initial", y ? "not-allowed" : "pointer", k, A, v ? "3px" : 0, w ? "center" : "initial", w ? "center" : "initial", C ? "14px" : "12px", L, L, m, h || p, L, v ? "inset 0px 0px 0px 2px ".concat(p) : "initial"]]
                    ]) + " " + (z && null != z.className && z.className || ""),
                    children: [D && (0, r.jsx)(c.Z, {
                        children: D
                    }), j, (0, r.jsx)(o(), {
                        id: "23472259c69ef05e",
                        dynamic: [L, S || "flex", R, d, b || p, v ? "inset 0px 0px 0px ".concat(g ? 2 : 1, "px ").concat(p) : "initial", y ? "not-allowed" : "pointer", k, A, v ? "3px" : 0, w ? "center" : "initial", w ? "center" : "initial", C ? "14px" : "12px", L, L, m, h || p, L, v ? "inset 0px 0px 0px 2px ".concat(p) : "initial"],
                        children: "".concat(L, ".__jsx-style-dynamic-selector{display:").concat(S || "flex", ";-webkit-box-flex:").concat(R, ";-webkit-flex:").concat(R, ";-moz-box-flex:").concat(R, ";-ms-flex:").concat(R, ";flex:").concat(R, ";background-color:").concat(d, ";color:").concat(b || p, ";-webkit-box-shadow:").concat(v ? "inset 0px 0px 0px ".concat(g ? 2 : 1, "px ").concat(p) : "initial", ";-moz-box-shadow:").concat(v ? "inset 0px 0px 0px ".concat(g ? 2 : 1, "px ").concat(p) : "initial", ";box-shadow:").concat(v ? "inset 0px 0px 0px ".concat(g ? 2 : 1, "px ").concat(p) : "initial", ";cursor:").concat(y ? "not-allowed" : "pointer", ";outline:none;border:none;padding:").concat(k, ";margin:").concat(A, ";-webkit-border-radius:").concat(v ? "3px" : 0, ";-moz-border-radius:").concat(v ? "3px" : 0, ";border-radius:").concat(v ? "3px" : 0, ";-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;-webkit-box-pack:").concat(w ? "center" : "initial", ";-webkit-justify-content:").concat(w ? "center" : "initial", ";-moz-box-pack:").concat(w ? "center" : "initial", ";-ms-flex-pack:").concat(w ? "center" : "initial", ";justify-content:").concat(w ? "center" : "initial", ";-webkit-box-align:").concat(w ? "center" : "initial", ";-webkit-align-items:").concat(w ? "center" : "initial", ";-moz-box-align:").concat(w ? "center" : "initial", ";-ms-flex-align:").concat(w ? "center" : "initial", ";align-items:").concat(w ? "center" : "initial", ";-webkit-align-self:stretch;-ms-flex-item-align:stretch;align-self:stretch;font-size:").concat(C ? "14px" : "12px", "}").concat(L, ".__jsx-style-dynamic-selector:hover,").concat(L, ".__jsx-style-dynamic-selector:focus{background-color:").concat(m, "!important;color:").concat(h || p, "}").concat(L, ".__jsx-style-dynamic-selector:focus{-webkit-box-shadow:").concat(v ? "inset 0px 0px 0px 2px ".concat(p) : "initial", ";-moz-box-shadow:").concat(v ? "inset 0px 0px 0px 2px ".concat(p) : "initial", ";box-shadow:").concat(v ? "inset 0px 0px 0px 2px ".concat(p) : "initial", "}")
                    })]
                }))
            }
        },
        67751: function(e, t, n) {
            ...
            t.Z = (0, u.f)((function(e) {
                var t = e.isVisible,
                    n = e.toggleVisibility,
                    i = (0, d.aC)();
                return l.ZP ? (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsxs)(s.Z, {
                        ...
                        children: [(0, r.jsx)("img", {
                            height: 20,
                            src: i ? i.photoURL : "/static/svg/github.svg",
                            alt: i ? i.displayName : "GitHub",
                            className: "jsx-ceaf54f5b1392562"
                        }), (0, r.jsx)("span", {
                            className: "jsx-ceaf54f5b1392562",
                            children: i ? i.displayName : "Sign in/up"
                        })]
                    }), (0, r.jsx)(f, {
                        isVisible: i && t
                    }), (0, r.jsx)(o(), {
        ...
        82129: function(e, t, n) {
            ...
            var u = function(e) {
                    ...
                    return (0, r.jsxs)("header", {
                        ...
                        children: [(0, r.jsxs)("div", {
                            ...
                            children: [(0, r.jsx)("a", {
                                ...
                                children: ["Create and share beautiful images of your source code.", (0, r.jsx)("br", {
                                    className: "jsx-86da1b8942f9dc09"
                ...
                b = function() {
                    return (0, r.jsxs)("footer", {
                        role: "contentinfo",
                        className: o().dynamic([
                            ["45980eb397865551", [p.DM.GRAY, p.DM.SECONDARY, p.DM.PRIMARY]]
                        ]) + " mt3",
                        children: [(0, r.jsxs)("nav", {
                            ...
                            children: ["created by", " ", (0, r.jsx)("a", {
                                href: "https://twitter.com/carbon_app",
                                className: o().dynamic([
                                    ["45980eb397865551", [p.DM.GRAY, p.DM.SECONDARY, p.DM.PRIMARY]]
                                ]) + " author-link",
                                children: "@carbon_app"
                            ...
                            id: "45980eb397865551",
                            dynamic: [p.DM.GRAY, p.DM.SECONDARY, p.DM.PRIMARY],
                            children: "footer.__jsx-style-dynamic-selector{font-size:14px;text-align:center}footer.__jsx-style-dynamic-selector>div.__jsx-style-dynamic-selector{text-align:center;color:".concat(p.DM.GRAY, "}nav.__jsx-style-dynamic-selector{margin:0 auto}a.__jsx-style-dynamic-selector{margin-right:1rem}a.__jsx-style-dynamic-selector:last-child{margin-right:0}.new.__jsx-style-dynamic-selector{position:absolute;margin:-4px 0 0 -12px;padding:1px 3px;color:").concat(p.DM.SECONDARY, ";background:#cd3f45;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px;font-size:8px;font-weight:600;line-height:1.3;text-transform:uppercase;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.author-link.__jsx-style-dynamic-selector{color:").concat(p.DM.PRIMARY, ";text-decoration:none}.author-link.__jsx-style-dynamic-selector:hover{color:#fff}")
                        })]
                    })
                };
            ...
            var h = "CARBON_CTA_4";
            var y = function() {
                    var e = m(c.useState(!1), 2),
                        t = (e[0], e[1]);
                    return c.useEffect((function() {
                        window.localStorage.removeItem("CARBON_CTA_2"), window.localStorage.removeItem("CARBON_CTA_3"), window.localStorage.getItem(h) || t(!0)
                    }), []), null
                },
                g = n(67751);
            ...
            var k = "\n  display: flex;\n  justify-content: center;\n  flex-direction: column;\n  align-items: center;\n",
                _ = function(e) {
                    ...
                    function s() {
                        return j(this, s), c.apply(this, arguments)
                    }
                    return t = s, (n = [{
                        key: "render",
                        value: function() {
                            ...
                            return (0, r.jsxs)("main", {
                                className: o().dynamic([
                                    ["18a780592a4dbbcf", [i ? k : "", k]]
                                ]) + " main mb3",
                                children: [(0, r.jsx)(l.ZP, {}), (0, r.jsxs)(a.ZP, {
                                    children: [(0, r.jsx)(y, {}), (0, r.jsx)(u, {
                                        enableHeroText: n
                                    }), (0, r.jsx)("div", {
                                        className: o().dynamic([
                                            ["18a780592a4dbbcf", [i ? k : "", k]]
                                    ...
                                    id: "18a780592a4dbbcf",
                                    dynamic: [i ? k : "", k],
                                    children: ".main.__jsx-style-dynamic-selector{".concat(i ? k : "", "\n              margin-top: 6rem;}.login-button-container.__jsx-style-dynamic-selector{position:absolute;top:1.4rem;right:1rem}.page.__jsx-style-dynamic-selector{max-width:100%;padding:0 1rem}@media(min-width:1024px){.main.__jsx-style-dynamic-selector{").concat(k, ";}.page.__jsx-style-dynamic-selector{padding:0}}")
                                })]
                            })
                        }
                    }]) && v(t.prototype, n), i && v(t, i), s
                }(c.Component),
                A = _
        },
        8694: function(e, t, n) {
            ...
            function s(e) {
                ...
                return (0, r.jsxs)("div", {
                    className: o().dynamic([
                        ["7cac043008ebd2b9", [c, t || "initial", n || "initial"]]
                    ]),
                    children: [(0, r.jsx)("div", {
                        ...
                        id: "7cac043008ebd2b9",
                        dynamic: [c, t || "initial", n || "initial"],
                        children: ".window-pointer.__jsx-style-dynamic-selector{width:0px;height:0px;border-style:solid;border-width:0 5px 6px 5px;border-color:transparent transparent ".concat(c, " transparent;position:absolute;top:-8px;left:").concat(t || "initial", ";right:").concat(n || "initial", "}")
                    })]
                })
            }
            var u = n(58299),
            ...
            function g(e, t) {
                return !t || "object" !== v(t) && "function" !== typeof t ? f(e) : t
            }
            ...
            var C = function(e) {
                    var t = function(t) {
                        ...
                        function i() {
                            var e;
                            return p(this, i), m(f(e = n.apply(this, arguments)), "state", {
                                isVisible: !1
                            }), m(f(e), "toggleVisibility", (function() {
                                return e.setState((0, d.ZN)("isVisible"))
                            })), m(f(e), "handleClickOutside", (function() {
                                return e.setState({
                                    isVisible: !1
                                })
                            })), m(f(e), "handleKeyDown", (function(t) {
                                "Escape" === t.key && e.handleClickOutside()
                            })), e
                        }
                        return x(i, [{
                    ...
                    return x(n, [{
                        ...
                        value: function() {
                            var e = this.props,
                                ...
                                l = e.pointerLeft,
                                d = e.pointerRight;
                            return a ? null : (0, r.jsxs)("div", {
                                id: t,
                                style: c,
                                className: o().dynamic([
                                    ["7cd279c6abbcaf83", [u.DM.BLACK, i]]
                                ]) + " popout",
                                children: [(0, r.jsx)(s, {
                                    fromLeft: l,
                                    fromRight: d,
                                    ...
                                    id: "7cd279c6abbcaf83",
                                    dynamic: [u.DM.BLACK, i],
                                    children: ".popout.__jsx-style-dynamic-selector{position:absolute;background-color:".concat(u.DM.BLACK, ";border:2px solid ").concat(i, ";-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px;margin-top:10px;font-size:12px;z-index:1}")
                                })]
                            })
                        }
                    }]), n
