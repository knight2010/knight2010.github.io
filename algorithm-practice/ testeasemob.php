...
{
	$formgettoken="https://a1.easemob.com/kshopping/drive/users";
	$body=array(
		"username"=>$nikename,
		"password"=>$pwd,
	);
...
{
	$formgettoken="https://a1.easemob.com/kshopping/drive/users/".$nikename."/password";
	$body=array(
		"newpassword"=>$newpwd,
	);
	$patoken=json_encode($body);
...
{
	$formgettoken="https://a1.easemob.com/kshopping/drive/users/".$nikename;
	$body=array();
	$patoken=json_encode($body);
	$header = array(_get_token());
	$method = "DELETE";
...
function _get_token()
{
	$formgettoken="https://a1.easemob.com/kshopping/drive/token";
	$body=array(
